...
const configFile = {
    ...
    DOMAIN_URL: process.env.DOMAIN_URI,
    PAYMENT_SUCCESS_URI: process.env.SUCCESS_URI,
    CANCEL_URI: process.env.CANCEL_URI,
    ORIGIN_PORT_DOMAIN: process.env.ORIGIN_PORT_DOMAIN,
    LOCATION_ACCESS_TOKEN: process.env.LOCATION_ACCESS_TOKEN,
    SEARCH_LOCATION: process.env.MAP_SEARCH_API,
