...
class BookingEnity {
    ...
    bookingCreation(data, carDetails) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (pickupLocation !== undefined &&
                    ...
                    bookingFormat = {
                        carId: (_b = (_a = carDetails._id) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '',
                        userId: data.userId,
                ...
                const bookingData = yield this.model.create(bookingFormat);
                if (bookingData !== null) {
                    console.log("Booked");
    ...
    findBooking(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (data === 'all') {
                    const bookingFinding = yield this.model.find().populate("carId");
                    ...
                    const bookingFinding = yield this.model.findOne({ _id: data }).populate("carId");
                    if (bookingFinding) {
    ...
    bookingFindingBasedOnRole(bookingData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log("updating");
                const bookingDetail = yield this.model.find(bookingData).populate('carId');
    ...
    BookingUpdater(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const booking = yield this.model.findById(bookingId);
                if (booking) {
    ...
    BookingPagination(data, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let bookings;
                let totalCount;
                if (typeof data === "string") {
                    bookings = yield this.model.find()
                        .skip((page - 1) * limit)
                        .limit(limit)
                        .populate('carId')
                        .exec();
                    totalCount = yield this.model.countDocuments();
                }
                else {
                    bookings = yield this.model.find(Object.assign({}, data))
                        .skip((page - 1) * limit)
                        .limit(limit)
                        .populate('carId')
                        .exec();
                    totalCount = yield this.model.countDocuments(Object.assign({}, data));
                }
